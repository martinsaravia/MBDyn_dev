...
%==========================================================================
function [X,gdof,m,kt,kg,fie,fde,fme,fae,SE,EE,AV] = scp2ll(FE,X,E,N,D,DM,U,Vel,Acc,SE,EE,el,AV)
...
% EE(1,el,X.tstep+1) = dx0'  *  du0 ;
% EE(2,el,X.tstep+1) = dphi' *  Ei2 ;  
% EE(3,el,X.tstep+1) = dphi' * -Ei3 ; 
% EE(4,el,X.tstep+1) = phii' * -Ei3 ; 
% EE(5,el,X.tstep+1) = phii' *  Ei2 ; 
